...
export default function SecretariesTab({ title, description }: SecretariesTabProps) {
  const {
    data: apiData,
    isLoading,
    isError,
      ...
      <div className="flex justify-center items-center h-[calc(100vh-160px)]">
        <div className="flex flex-col items-center gap-4 p-4 max-w-md text-center">
          <p className="text-destructive">
            {"Impossible de charger les secrétaires. Veuillez réessayer plus tard."}
          </p>
  ...
  const secretaries = apiData?.data ?? [];

...
export default function StudentsTab({ title, description }: StudentsTabProps) {
  const {
    data: apiData,
    isLoading,
    isError,
    refetch,
  } = useListUserByRoleQuery({ role: UserRole.STUDENT });
      ...
      <div className="flex justify-center items-center h-[calc(100vh-160px)]">
        <div className="flex flex-col items-center gap-4 p-4 max-w-md text-center">
          <p className="text-destructive">
            {"Impossible de charger les étudiants. Veuillez réessayer plus tard."}
          </p>

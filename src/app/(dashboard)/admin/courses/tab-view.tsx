  ...
  return (
    <Tabs defaultValue="courses" className="w-full">
      <TabsList className="py-4 px-2.5 bg-white border font-semibold">
        <TabsTrigger value="courses" className="p-3.5">
          Cours
        </TabsTrigger>
        <TabsTrigger value="roles" className="p-3.5">
          Rôles
        </TabsTrigger>
      </TabsList>
      <TabsContent value="courses">
        <div className="overflow-x-auto p-8 my-4 shadow-md border border-border rounded-md bg-white">
